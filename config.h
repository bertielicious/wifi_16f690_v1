...
#define GREEN_LED PORTBbits.RB6 // diagnostic LED
...
uchar copy_of_at_code[20];

const uchar at_code[] = "\0,AT,AT+RST,AT+GMR,AT+GSLP,ATE,AT+RESTORE,AT+UART?,AT+UART_CUR,AT+UART_DEF,AT+SLEEP,AT+WAKEUPGPIO\0";
const uchar message[] = "UP DOWN or OK ?";
uchar *ptr2 = &at_code[2];
uchar y = 0;
uchar z = 0;
#ifdef	__cplusplus
}
